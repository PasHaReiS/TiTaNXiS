...
# → routes/members_admin.py (Refactor Phase 3)
# NOTE: /members/{id}/history helper class kept here (find_or_create_alliance)
# because it's used by member create/patch too.
...
# /members/{id}/changes + bulk-country + bulk-rank → routes/members_admin.py
...
# /members/bulk-alliance → routes/members_admin.py (Refactor Phase 3)
...
from routes.members_admin import make_members_admin_router
app.include_router(make_members_admin_router(
    db, require_edit,
